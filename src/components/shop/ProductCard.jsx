...
import { CatalogAPI, SUPPLIERS, CATEGORIES } from "../../data/products.js";
  ...
  return (
    ...
    >
      <div className="thumb">
        ...
        <span className="quick-view">Tap for full details →</span>
      </div>
      <div className="body">
        <span className="cat-chip">{CATEGORIES.find((c) => c.id === product.category)?.name || product.category}</span>
        <h3>{product.name}</h3>
